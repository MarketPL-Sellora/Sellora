...
(2, 1, 3, 'MacBook Pro M3 14"', '18GB RAM, 512GB SSD', 5, 85000.00, 80000.00, 2, 'ACTIVE'),
(3, 2, 2, 'Samsung Galaxy S24 Ultra', 'Titanium Gray', 20, 50000.00, 46000.00, 3, 'ACTIVE'),
(4, 2, 1, 'Samsung Galaxy Watch 6', '44mm, Graphite', 30, 12000.00, NULL, NULL, 'ACTIVE'),
(5, 3, 5, 'Nike Air Force 1', 'White, Size 42', 50, 4500.00, 4000.00, 5, 'ACTIVE'),
(6, 3, 5, 'Nike Dunk Low', 'Panda, Size 40', 0, 5200.00, NULL, NULL, 'OUT_OF_STOCK'),
(7, 3, 4, 'Nike Sportswear Tech Fleece', 'Black Hoodie', 25, 4800.00, NULL, NULL, 'ACTIVE'),
(8, 4, 8, 'Дюна. Френк Герберт', 'Тверда обкладинка', 100, 650.00, NULL, NULL, 'ACTIVE'),
(9, 4, 8, '1984. Джордж Оруелл', 'Ексклюзивне видання', 80, 450.00, 350.00, 10, 'ACTIVE'),
(10, 5, 7, 'Кава Ефіопія 1кг', '100% Arabica', 40, 950.00, 800.00, 4, 'ACTIVE'),
(11, 5, 7, 'Кава Колумбія 500г', 'Decaf', 20, 600.00, NULL, NULL, 'ACTIVE'),
(12, 1, 2, 'iPhone 13 128GB', 'Old model', 0, 25000.00, NULL, NULL, 'ARCHIVED'),
(13, 2, 3, 'Samsung Galaxy Book 3', 'i7, 16GB', 10, 45000.00, 42000.00, 2, 'ACTIVE'),
(14, 4, 8, 'Clean Code. Robert Martin', 'IT Books', 15, 1200.00, NULL, NULL, 'ACTIVE'),
(15, 5, 7, 'Дріп-кава Мікс', 'Упаковка 10 шт', 150, 300.00, 250.00, 5, 'ACTIVE'),
(16, 1, 3, 'iPad Pro 11" M4', 'Wi-Fi 256GB', 12, 45000.00, NULL, NULL, 'ACTIVE'),
(17, 1, 2, 'iPhone 14 128GB', 'Midnight', 25, 30000.00, 28000.00, 5, 'ACTIVE'),
(18, 2, 2, 'Samsung Galaxy A55', 'Awesome Navy', 40, 18000.00, NULL, NULL, 'ACTIVE'),
(19, 2, 1, 'Samsung Galaxy Buds 2 Pro', 'White', 35, 6000.00, 5500.00, 4, 'ACTIVE'),
(20, 3, 5, 'Nike Air Max 270', 'Black/White', 20, 5500.00, NULL, NULL, 'ACTIVE'),
(21, 3, 4, 'Nike Dri-FIT T-Shirt', 'Training shirt', 100, 1200.00, 1000.00, 10, 'ACTIVE'),
(22, 4, 8, 'Design Patterns (GoF)', 'Erich Gamma', 10, 1500.00, NULL, NULL, 'ACTIVE'),
(23, 4, 8, 'Grokking Algorithms', 'Aditya Bhargava', 30, 900.00, 800.00, 5, 'ACTIVE'),
(24, 5, 7, 'Кава Бразилія 1кг', 'Сантос, 100% Арабіка', 60, 850.00, NULL, NULL, 'ACTIVE'),
(25, 5, 7, 'Фільтр-пакети Hario V60', '100 шт', 200, 250.00, 200.00, 10, 'ACTIVE'),
(26, 1, 3, 'MacBook Air M2 13"', '8GB/256GB Space Gray', 18, 42000.00, 40000.00, 3, 'ACTIVE'),
(27, 2, 3, 'Samsung Odyssey G5', '27" Monitor', 8, 14000.00, NULL, NULL, 'ACTIVE'),
(28, 3, 5, 'Nike Pegasus 40', 'Running shoes', 45, 4800.00, 4200.00, 4, 'ACTIVE'),
(29, 4, 8, 'Майстер і Маргарита', 'Подарункове видання', 25, 700.00, NULL, NULL, 'ACTIVE'),
(30, 5, 7, 'Кава Гватемала 250г', 'Спешелті', 30, 450.00, NULL, NULL, 'ACTIVE');
