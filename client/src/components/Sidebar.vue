...
<template>
  <aside class="w-52 self-stretch inline-flex flex-col justify-start items-start gap-4">
    ...
    >
      ...
      <div class="w-44 px-3 pt-4 pb-3 bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-xl outline outline-1 outline-offset-[-1px] outline-orange-500/20 flex flex-col justify-start items-start gap-[3.30px]">
    ...
    <div class="self-stretch p-4 bg-[#1c1f2a] rounded-2xl outline outline-1 outline-offset-[-1px] outline-white/5 flex flex-col justify-start items-start gap-2">
