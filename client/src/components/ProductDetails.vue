    ...
    <div class="self-stretch px-5 py-8 bg-gradient-to-br from-[#1a0f05] via-[#1c1209] to-[#160d04] rounded-2xl outline outline-2 outline-offset-[-2px] outline-orange-500 flex flex-col gap-2">
      ...
      <div class="self-stretch inline-flex justify-between items-center">
        ...
        <div class="px-2.5 py-1 bg-orange-500/10 rounded-lg outline outline-1 outline-offset-[-1px] outline-orange-500/30">
          <span class="text-orange-400 text-xs font-normal font-['Onest'] leading-4">Економія {{ fmt(product.savings) }}</span>
        </div>
      </div>
      ...
      <div class="w-full overflow-hidden flex flex-wrap items-baseline gap-x-3 gap-y-1 py-1">
        ...
        <div class="flex items-center gap-2">
          <span class="text-[#5a5f7a] text-lg md:text-xl font-normal font-['Onest'] line-through leading-tight">{{ fmt(product.oldPrice) }}</span>
      ...
      <template v-if="sessionData">
        ...
        <button
          v-else
          class="w-full h-14 py-4 bg-orange-500 rounded-xl text-white text-[11px] sm:text-xs md:text-base font-normal font-['Unbounded'] leading-6 tracking-wide transition-all duration-150 hover:bg-orange-400 hover:shadow-[0px_4px_24px_0px_rgba(249,115,22,0.55)] active:scale-[0.99] active:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#160d04] disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <template v-else>
        <button
          class="w-full h-14 py-4 bg-orange-500 rounded-xl text-white text-[11px] sm:text-xs md:text-base font-normal font-['Unbounded'] leading-6 tracking-wide transition-all duration-150 hover:bg-orange-400 hover:shadow-[0px_4px_24px_0px_rgba(249,115,22,0.55)] active:scale-[0.99] active:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#160d04]"
